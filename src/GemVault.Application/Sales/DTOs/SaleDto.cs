...
public record SaleDto(Guid Id, DateTime SaleDate, string? BuyerName, string? BuyerEmail, string? BuyerPhone, string? Notes, List<SaleItemDto> Items, decimal TotalSaleValue, DateTime CreatedAt);
