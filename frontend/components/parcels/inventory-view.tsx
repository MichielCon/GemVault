...
export function ParcelInventoryView({ result, page, search, status }: Props) {
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b bg-muted/30 text-left">
            <th className="px-4 py-2.5 text-xs font-medium text-muted-foreground">Parcel</th>
            ...
            <th className="px-4 py-2.5 text-xs font-medium text-muted-foreground">Qty</th>
            <th className="px-4 py-2.5 text-xs font-medium text-muted-foreground hidden sm:table-cell">Total Weight</th>
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center rounded-xl border border-dashed bg-card py-20 text-center">
      <Package size={40} strokeWidth={1} className="mb-3 text-muted-foreground/50" />
